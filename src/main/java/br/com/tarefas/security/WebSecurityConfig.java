...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:8081")); //inserir qual site vai ter acesso podera por *
        configuration.setAllowedMethods(Arrays.asList("*")); // quais metodos sao permitidos get post..
        configuration.setAllowedMethods(Arrays.asList("*")); // permitir metodos de cabeçalho na requisição
